...
public class TicksPublisherTest {
    ...
    public void shouldGenerateOneTick() throws Exception {
        ...
        subscriber.expectCompletion(100L);
        subscriber.expectNone(100L);
    }
    ...
    @Test
    public void shouldGenerateTicksAfterPeriod() throws Exception {
        ManualSubscriberWithSubscriptionSupport<Long> subscriber =
            new ManualSubscriberWithSubscriptionSupport<>(new TestEnvironment());
    ...
    @Test
    public void shouldThrowIllegalArgumentIfCountInvalid() {
        ...
        assertThrows(IllegalArgumentException.class, () -> new TicksPublisher(0, 1, TimeUnit.SECONDS));
    }
